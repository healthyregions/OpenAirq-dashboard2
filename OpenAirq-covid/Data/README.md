...
| 4 | [Asthma ED Visits](Asthma2017.csv) | This dataset is automatically generated using raw data from the [Chicago Healh Atlas](https://www.chicagohealthatlas.org/indicators). Each column contains the 2017 rate of ED visits per 10,000 people, separated by age group, while each row is a administrative region represented by zipcode.| Final |
